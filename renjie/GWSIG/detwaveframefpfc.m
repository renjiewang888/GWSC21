function [fPlus,fCross] = detwaveframefpfc(polAngleTheta,polAnglePhi,Psi)
%Antenna pattern functions in wave frame (arms at 90 degrees)
%[Fp,Fc]=DETWAVEFRAMEFPFC(T,P,Psi)
...
%%rotation: multiply a roration matrix 
for lpl = 1:nLocs
